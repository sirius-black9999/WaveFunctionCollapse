...
namespace SpellCasting
{
    public static class Bookmaker
    {
        ...
        {
            { "Fireball", new[]{ new[] { Aspect.Aeolis, Aspect.Ignis, Aspect.Empyrus, Aspect.Luminus, Aspect.Spatius,Aspect.Levitas, Aspect.Malus, Aspect.Disis } } },
            { "Ice shard", new[]{ new[] { Aspect.Tellus, Aspect.Hydris, Aspect.Vitrio, Aspect.Luminus, Aspect.Spatius,Aspect.Gravitas, Aspect.Malus, Aspect.Disis } } },
            ...
            { "Acid", new[]{ new[] { Aspect.Aeolis, Aspect.Ignis, Aspect.Empyrus, Aspect.Noctis, Aspect.Spatius,Aspect.Gravitas, Aspect.Malus, Aspect.Iuxta } } },
